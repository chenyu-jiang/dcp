...
print(
    f"The default implementation runs in "
    f"{default_time:.3f} "
    "microseconds"
)
...
with sdpa_kernel(SDPBackend.CUDNN_ATTENTION):
    try:
        ...
        print(
            f"The CUDNN implementation runs in {efficient_time:.3f} microseconds"
        )
    except RuntimeError:
        print("CUDNN Attention is not supported. See warnings for reasons.")
